    ...
    static async create(paymentData) {
        try {
            ...
            const [result] = await pool.query(
                "INSERT INTO payments (payment_id, payment_date, payment_for, type, payment_reason, amount, registered_by) VALUES (?, ?, ?, ?, ?, ?, ?)",
                [
                    payment_id,
                    paymentData.payment_date,
                    paymentData.payment_for,
                    paymentData.type,
                    paymentData.payment_reason,
                    paymentData.amount,
                    paymentData.registered_by,
                ]
            );
